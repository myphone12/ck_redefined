...
class InnerWindow:
    ...
    def __init__(self,tk1,title:str = 'title'):
        ...
        self.innershadow = tk.Label(self.mainwindow,background='black',textvariable=self.innertext,foreground='white',anchor='sw',justify='left',font=('Consolas',10))
        self.innershadow.place(x=2,y=2,width=396,height=96)
        self.titlebar = tk.Label(self.mainwindow,text=title,background='gray',anchor='w',relief='groove',font=('Consolas',10))
